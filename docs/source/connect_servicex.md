...
You need a [ServiceX endpoint](select-endpoint) where transformation is happening and
a [client library](client-installation) to submit a transformation request.
