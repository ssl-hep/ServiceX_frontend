...
### Func\_ADL Uproot Query Example

This example uses an Func\_ADL to extract the `AnalysisElectronsAuxDyn.pt` branch
from the `CollectionTree` tree in ATLAS PHYSLITE OpenData Dataset.
...
([ATLAS DAOD PHYSLITE format Run 2 2016 proton-proton collision data](https://opendata.cern.ch/record/80001)).
